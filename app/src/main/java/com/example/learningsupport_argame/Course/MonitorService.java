...
public class MonitorService extends Service {
                ...
                mMonitorThread = new Thread(new Runnable() {
                        ...
                        public void run() {
                                ...
                                while (!Thread.interrupted()) {
                                        ...
                                        mRemoteViews.setTextViewText(R.id.monitor_notification_task_name, "语文");

                                        mRemoteViews.setTextViewText(R.id.monitor_notification_task_remaining_time, second2Time(mRemainingTime));

                                        mRemoteViews.setTextViewText(R.id.monitor_notification_task_begin_time, mCourse.getmCourseStartAt().substring(5));

                                        mRemoteViews.setTextViewText(R.id.monitor_notification_task_end_time, mCourse.getmCourseEndIn().substring(5));
        ...
        public void setTask(MonitorCourse course) {

                mCourse = course;

                mRemainingTime = remainingTime(mCourse.getmCourseStartAt(), mCourse.getmCourseEndIn());
