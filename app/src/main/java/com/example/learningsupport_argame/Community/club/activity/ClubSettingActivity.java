...
public class ClubSettingActivity extends Activity {
    private static final int ALBUM_REQUEST_CODE = 2;
    private static final int CROP_REQUEST_CODE = 3;
    private CardView mViewMemberCardView;
    private CardView mDissolveCardView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mViewMemberCardView.setOnClickListener(v -> {
            Intent intent = new Intent(this, ClubMembersActivity.class);
            intent.putExtra("club_id", mClub.getId());
            intent.putExtra("manager_id", mClub.getManagerId());
            startActivity(intent);
        });
        mDissolveCardView = findViewById(R.id.club_dissolve);
        mDissolveCardView.setOnClickListener(v -> {
            new AlertDialog.Builder(ClubSettingActivity.this)
                    .setTitle("解散社团")
                    .setMessage("确定要解散社团吗？解散后将无法恢复")
        ...
        mReturnLayout = findViewById(R.id.club_setting_return);
        ...
        mSubmitButton = findViewById(R.id.club_setting_submit);
        mSubmitButton.setOnClickListener(v -> {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("确认要更新数据？")
                    .setPositiveButton("确认", (dialog, which) -> {
                        new Thread(() -> ClubLab.update(mClub)).start();
                    })
                    .setNegativeButton("取消", null)
                    .show();
        });
    ...
    void initData(Club club) {
        mClubCoverImage.setImageBitmap(club.getCoverBitmap());
        mClubNameET.setText(club.getClubName());
        mClubTypeET.setText(club.getClubType());
        mClubDescET.setText(club.getClubDesc());
        mClubMemberNumTV.setText(club.getClubMaxMember() + "人");
    }
